...
public class CmsChild2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Cursor c0 = dba.getScreenName("11", Constant.LANGUAGE_ID);
		...
		Cursor c = dba.getCms2(Constant.LANGUAGE_ID, ParentID);
  ...
  if (c2.getCount() > 0) {
	  ...
	  layout_background_color="#c5c678";
			...
			Cursor cur = dba
					.row_query("select * from tbl_Cms_Details2 where CmsID="
			...
			String cnt = " No Data Found",content=" ";
			...
			((WebView) findViewById(R.id.web_cms)).loadDataWithBaseURL(null,
					cur.getString(5), "text/html", "UTF-8", null);
