...
public class CmsChild1 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		System.out.println("Parent id1:::" + ParentID);
		...
		Cursor c0 = dba.getScreenName("10", Constant.LANGUAGE_ID);
		...
		Cursor c = dba.getCms1(Constant.LANGUAGE_ID, ParentID);

		System.out.println("cms1 count::::::"+c.getCount());
  ...
  if (c2.getCount() > 0) {
	  ...
	  if(!c2.getString(0).startsWith("#")){
		...
		((LinearLayout) findViewById(R.id.lay_cd)).setBackgroundColor(Color
	  ...
	  layout_background_color="#c5c678";
			...
			Cursor cur = dba
					.row_query("select * from tbl_Cms_Details1 where CmsID="
							+ ParentID +" and LanguageID="+Constant.LANGUAGE_ID+"");
			...
			if (!Webview_data.equals(null)) {
				...
				content += cnt+Webview_data + "</body></html>";
			...
			((WebView) findViewById(R.id.web_cms)).setBackgroundColor(Color.parseColor(layout_background_color));
