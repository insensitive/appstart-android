...
public class ImageGalleryCategory1 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.imagegallerycategory1);
		...
		list = (ListView) findViewById(R.id.list_igc1);
		...
		Cursor c1 = dba.getScreenName("12", Constant.LANGUAGE_ID);
		...
		Cursor cur = dba.getImageGalleryCategory1(Constant.LANGUAGE_ID);
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Bundle b = new Bundle();
				b.putString("cat_id", cat_id.get(arg2).toString());
				b.putString("cat_name", cat_name.get(arg2).toString());
				b.putBoolean("showBack", true);

				Intent edit = new Intent(getParent(), ImageGallery1.class);

				edit.putExtras(b);
				TabGroupActivity parentActivity = (TabGroupActivity) getParent();
				parentActivity.startChildActivity("ImageGallery1", edit);
